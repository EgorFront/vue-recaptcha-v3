...
export var VueReCaptcha = {
    install: function (app, options) {
        ...
        if (options.instantLoading)
            void deferLoading(app, options);
        app.provide(VueReCaptchaInjectKey, {
            instance: instance,
            isLoaded: isLoaded,
            executeRecaptcha: recaptcha(instance),
            recaptchaLoaded: recaptchaLoaded(isLoaded),
            deferLoading: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, deferLoading(app, options)];
...
function deferLoading(app, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, initializeReCaptcha(options)];
                case 1:
                    wrapper = _a.sent();
                    isLoaded.value = true;
